...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        """" main method to run the square class"""
        self.size = size
        self.position = position

    def __str__(self):
        """str method to set print the shape and size"""
        txt = ''
        if (self.__size == 0):
            pass
        else:
    ...
    def area(self):
        """calculates the area of the shape in question (square)
        """
        return (self.size ** 2)

    def my_print(self):
        """prints a square  along with it varying size
